...
def switch_dataframe_2_options(n_switches, t_steps_drug, t_steps_no_drug, nOC, nOB, nMMd,
    ...
    for i in range(n_switches):
        ...
        if x == 0:
            ...
            t = np.linspace(time, time + t_steps_drug, int(t_steps_drug))
            y0 = [nOC, nOB, nMMd, nMMr]
...
def switch_dataframe_GF_h_comb_h_W_h(n_rounds, t_steps_GF_IH, t_steps_WMMd_IH,
            t_steps_comb, t_steps_no_drug, nOC, nOB, nMMd, nMMr, growth_rates,
            growth_rates_IH, decay_rates, decay_rates_IH, matrix_no_GF_IH,
            matrix_GF_IH, matrix_GF_IH_comb, WMMd_inhibitor, WMMd_inhibitor_comb):
    """ Function that makes a dataframe of the nOC, nOB, nMMd and nMMr values over
    ...
    for i in range(n_rounds):
        ...
        if x == 2:
            ...
            t = np.linspace(time, time + t_steps_comb, int(t_steps_comb))
            y0 = [nOC, nOB, nMMd, nMMr]
            parameters = (growth_rates_IH, decay_rates_IH, matrix, WMMd_inhibitor_comb)
...
def switch_dataframe_W_h_comb_h_GF_h(n_rounds, t_steps_GF_IH, t_steps_WMMd_IH,
            t_steps_comb, t_steps_no_drug, nOC, nOB, nMMd, nMMr, growth_rates,
            growth_rates_IH, decay_rates, decay_rates_IH, matrix_no_GF_IH,
            matrix_GF_IH, matrix_GF_IH_comb, WMMd_inhibitor, WMMd_inhibitor_comb):
    """ Function that makes a dataframe of the nOC, nOB, nMMd and nMMr values over
...
def switch_dataframe_GF_comb2_0_W_h(n_rounds, t_steps_GF_IH, t_steps_WMMd_IH,
            t_steps_comb, t_steps_no_drug, nOC, nOB, nMMd, nMMr, growth_rates,
            growth_rates_IH, decay_rates, decay_rates_IH, matrix_no_GF_IH,
...
def switch_dataframe_W_comb2_0_GF_h(n_rounds, t_steps_GF_IH, t_steps_WMMd_IH,
            t_steps_comb, t_steps_no_drug, nOC, nOB, nMMd, nMMr, growth_rates,
            growth_rates_IH, decay_rates, decay_rates_IH, matrix_no_GF_IH,
            matrix_GF_IH, matrix_GF_IH_comb, WMMd_inhibitor):
    """ Function that makes a dataframe of the nOC, nOB, nMMd and nMMr values over
...
def switch_dataframe_W_comb_h(n_rounds, t_steps_WMMd_IH, t_steps_comb,
    ...
    WMMd_inhibitor: Float
        The effect of a drug on the MMd fitness.
    WMMd_inhibitor_comb: Float
        The effect of a drug on the MMd fitness when both IHs are administered
...
def switch_dataframe_GF_comb_h(n_rounds, t_steps_GF_IH, t_steps_comb,
            t_steps_no_drug, nOC, nOB, nMMd, nMMr, growth_rates,
            growth_rates_IH, decay_rates, decay_rates_IH, matrix_no_GF_IH,
            matrix_GF_IH, matrix_GF_IH_comb, WMMd_inhibitor_comb):
    """ Function that makes a dataframe of the nOC, nOB, nMMd and nMMr values over
    time. First a WMMd IH is administerd, then a MMd GF IH and then there is a
    drug holliday.
...
def minimise_MM_W_comb_GF_h_IH():
    ...
    # GF IH s, comb W IH s]
    t_step_IH_strength = [3, 3, 3, 3, 0.4, 0.4, 0.3, 0.2]
...
def minimise_MM_GF_comb_W_h_IH():
    ...
    result = minimize(minimal_tumour_nr_t_4_situations_IH, t_step_IH_strength,
        ...
        growth_rates_IH, decay_rates, decay_rates_IH, matrix_no_GF_IH,
        matrix_GF_IH, matrix_GF_IH_comb), bounds = [(0, None), (0, None), (0, None),
        (0, None), (0, 0.55), (0, 0.6), (0, 0.4), (0, 0.4)], method='Nelder-Mead')
...
def minimal_tumour_nr_t_3_situations_IH_2_0(t_steps_IH_strength, function_order, nOC,
                nOB, nMMd, nMMr, growth_rates, growth_rates_IH, decay_rates,
                decay_rates_IH, matrix_no_GF_IH, matrix_GF_IH, matrix_GF_IH_comb):
    """ Function that makes a dataframe of the nOC, nOB, nMMd and nMMr values over
    time for a given MMd GF IH administration, WMMd IH administration, IH
...
###########################################
########################################
def minimal_tumour_nr_t_3_situations_GF_comb_h(t_steps_IH_strength, function_order,
                nOC, nOB, nMMd, nMMr, growth_rates, growth_rates_IH, decay_rates,
                decay_rates_IH, matrix_no_GF_IH, matrix_GF_IH, matrix_GF_IH_comb):
    """ Function that makes a dataframe of the nOC, nOB, nMMd and nMMr values over
    time for a given MMd GF IH administration or WMMd IH administration, IH
    combination administration and holiday duration.
    ...
    # Create a dataframe of the numbers
    df = function_order(n_rounds, t_steps_GF_IH, t_steps_comb, t_steps_no_drug,
        nOC, nOB, nMMd, nMMr, growth_rates, growth_rates_IH, decay_rates,
        decay_rates_IH, matrix_no_GF_IH, matrix_GF_IH, matrix_GF_IH_comb,
        WMMd_inhibitor_comb)
...
def minimal_tumour_nr_t_3_situations_W_comb_h(t_steps_IH_strength, function_order,
                nOC, nOB, nMMd, nMMr, growth_rates, growth_rates_IH, decay_rates,
    ...
    """
    t_steps_WMMd_IH, t_steps_comb, t_steps_no_drug, WMMd_inhibitor,\
                        WMMd_inhibitor_comb, GF_IH_comb, = t_steps_IH_strength
    ...
    # Create a dataframe of the numbers
    df = function_order(n_rounds, t_steps_WMMd_IH, t_steps_comb, t_steps_no_drug,
            nOC, nOB, nMMd, nMMr, growth_rates, growth_rates_IH, decay_rates,
            decay_rates_IH, matrix_no_GF_IH, matrix_GF_IH_comb,
...
def minimise_MM_GF_W_h():
    ...
    t_step_IH_strength = [4, 4, 2, 0.3, 0.4]
...
def minimise_MM_W_comb_GF_h():
    ...
    result = minimize(minimal_tumour_nr_t_4_situations, t_step_guess, args=(\
        ...
        growth_rates_IH, decay_rates, decay_rates_IH, matrix_no_GF_IH,
        matrix_GF_IH, matrix_GF_IH_comb, WMMd_inhibitor, WMMd_inhibitor_comb),
        bounds = [(0, None), (0, None), (0, None), (0, None)], method='Nelder-Mead')
...
def minimise_MM_GF_comb_h():
    ...
    # comb W IH s]
    t_step_IH_strength = [3, 3, 3, 0.4, 0.1, 0.1]
    result = minimize(minimal_tumour_nr_t_3_situations_GF_comb_h,
            t_step_IH_strength, args=(switch_dataframe_GF_comb_h, nOC, nOB, nMMd,
            nMMr, growth_rates, growth_rates_IH, decay_rates, decay_rates_IH,
            matrix_no_GF_IH, matrix_GF_IH, matrix_GF_IH_comb), bounds = [(0, None),
            (0, None), (0, None), (0, 0.5), (0, 0.5), (0, None)],
            method='Nelder-Mead')

    # Print the results
    print('Order: GF MMd IH -> IH combination -> holiday -> GF MMd IH etc.')
    print(f"""The best MMd GF IH add duration is {result.x[0]} generations
    The best IH combination duration is {result.x[1]} generations
    The best holliday duration is {result.x[2]} generations
    The best MMd GF IH strength when given alone is {result.x[3]}
    The MMd GF IH strength when given as a combination is {result.x[4]}
...
def minimise_MM_W_comb_h():
    ...
    # Optimize the administration and holliday durations and the IH stregths
    # t_step_IH_strength = [GF IH t, W IH t, comb t, h t, W IH s, comb W IH s,
    # comb GF IH s]
    t_step_IH_strength = [3, 3, 3, 0.4, 0.1, 0.1]
    result = minimize(minimal_tumour_nr_t_3_situations_W_comb_h,
            t_step_IH_strength, args=(switch_dataframe_W_comb_h, nOC, nOB, nMMd,
            nMMr, growth_rates, growth_rates_IH, decay_rates, decay_rates_IH,
            matrix_no_GF_IH, matrix_GF_IH_comb), bounds = [(0, None), (0, None),
            (0, None), (0, 0.5), (0, 0.5), (0, None)], method='Nelder-Mead')

    # Print the results
    print('Order: WMMd IH -> IH combination -> holiday -> WMMd IH etc.')
    print(f"""The best MMd GF IH add duration is {result.x[0]} generations
    The best IH combination duration is {result.x[1]} generations
    The best holliday duration is {result.x[2]} generations
    The best WMMd IH strength when given alone is {result.x[3]}
    The best WMMd IH strength when given as a combination is {result.x[4]}
...
def minimal_tumour_numb_t_steps_2_options(t_steps, nOC, nOB, nMMd,
                nMMr, growth_rates, growth_rates_IH, decay_rates, decay_rates_IH,
                 matrix_no_GF_IH, matrix_GF_IH, WMMd_inhibitor = 0):
    """ Function that makes a dataframe of the nOC, nOB, nMMd and nMMr values over
    time for a given time of a drug holiday.
    ...
    """
    t_steps_drug, t_steps_no_drug = t_steps
    # Deteremine the number of switches
    time_step = (t_steps_drug + t_steps_no_drug) / 2
    n_switches = int((400 // time_step) -1)

    # Create a dataframe of the numbers
    df = switch_dataframe_2_options(n_switches, t_steps_drug, t_steps_no_drug, nOC, nOB,
                nMMd, nMMr, growth_rates, growth_rates_IH, decay_rates,
                decay_rates_IH, matrix_no_GF_IH, matrix_GF_IH, WMMd_inhibitor)
...
def minimal_tumour_numb_WMMd_IH(WMMd_inhibitor, nOC, nOB, nMMd, nMMr, growth_rates,
    growth_rates_IH, decay_rates, decay_rates_IH, matrix, WMMd_inhibitor_array):
    """Function that determines the number of the population being MM for a
...
def Figure_3D_MM_numb_IH_add_and_holiday():
    ...
    t_step_guess = [2, 2]
    result = minimize(minimal_tumour_numb_t_steps_2_options, t_step_guess,
    ...
    result = minimize(minimal_tumour_numb_t_steps_2_options, t_step_guess,
                    args=(nOC, nOB, nMMd, nMMr, growth_rates, growth_rates_IH,
                    decay_rates, decay_rates_IH, matrix_no_GF_IH, matrix_no_GF_IH,
                    WMMd_inhibitor), method='Nelder-Mead')
    ...
    result = minimize(minimal_tumour_numb_t_steps_2_options, t_step_guess,
                    args=(nOC, nOB, nMMd, nMMr, growth_rates, growth_rates_IH,
                    decay_rates, decay_rates_IH, matrix_no_GF_IH, matrix_GF_IH_comb,
                    WMMd_inhibitor_comb), method='Nelder-Mead')

...
University:   UvA
Student id':  13717405
Description:  In this code functions are given that are used to make the plots.
              The data for the plots is generated by the code in cancer_model.py.
              The plots show the influence of, collective interactions, nonlinear
              benefits, different treatment methods and MM resistance levels.
"""
...
def figure_10():
    ...
    save_data(df_figure_10, 'data_figure_10.csv',
                                r'..\data\reproduced_data_Sartakhti_non_linear')
    ...
    save_figure(plt, 'Benefit_function_figure_10',
                    r'..\visualisation\reproduced_results_Sartakhti_non_linear')
    plt.show()
...
def figure_3():
    ...
    # Extract the solution and create dataframe
    xOC_values, xOB_values, xMM_values = y[:, 0], y[:, 1], y[:, 2]
    df_figure_3_non_linear = pd.DataFrame({'Generation': t, 'xOC': xOC_values,
                                            'xOB': xOB_values, 'xMM': xMM_values})
...
def figure_4():
    ...
    # Extract the solution and create dataframe
    xOC_values, xOB_values, xMM_values = y[:, 0], y[:, 1], y[:, 2]
    df_figure_4_non_linear = pd.DataFrame({'Generation': t, 'xOC': xOC_values,
                                            'xOB': xOB_values, 'xMM': xMM_values})
...
def figure_5():
    ...
    # Extract the solution and create dataframe
    xOC_values, xOB_values, xMM_values = y[:, 0], y[:, 1], y[:, 2]
    df_figure_5_non_linear = pd.DataFrame({'Generation': t, 'xOC': xOC_values,
                                            'xOB': xOB_values, 'xMM': xMM_values})
...
def figure_6():
    ...
    # Extract the solution and create dataframe
    xOC_values, xOB_values, xMM_values = y[:, 0], y[:, 1], y[:, 2]
    df_figure_6_non_linear = pd.DataFrame({'Generation': t, 'xOC': xOC_values,
                                            'xOB': xOB_values, 'xMM': xMM_values})
...
def figure_7():
    ...
    # Extract the solution and create dataframe
    xOC_values, xOB_values, xMM_values = y[:, 0], y[:, 1], y[:, 2]
    df_figure_7_non_linear = pd.DataFrame({'Generation': t, 'xOC': xOC_values,
                                            'xOB': xOB_values, 'xMM': xMM_values})
...
def figure_8():
    ...
    # Extract the solution and create dataframe
    xOC_values, xOB_values, xMM_values = y[:, 0], y[:, 1], y[:, 2]
    df_figure_8_non_linear = pd.DataFrame({'Generation': t, 'xOC': xOC_values,
                                            'xOB': xOB_values, 'xMM': xMM_values})

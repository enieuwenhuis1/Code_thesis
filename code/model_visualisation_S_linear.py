...
from model_S_non_linear import *
...
def figure_12A_right():
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_12A_right_second_line = pd.concat([df_figure_12A_right_second_line,
                                                        new_row], ignore_index=True)
...
def figure_12C_right():
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_12C_right_second_line = pd.concat([df_figure_12C_right_second_line,
                                                    new_row], ignore_index=True)

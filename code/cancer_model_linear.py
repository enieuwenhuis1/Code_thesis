...
def figure_2():
    ...
    for generation in range(generations):
        ...
        # Update the xOC, xOB, xMM values and nOC, nOB, nMM values
...
def figure_3():
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_3_first_line = pd.concat([df_figure_3_first_line, new_row], ignore_index=True)

        # Update the xOC, xOB, xMM values nd the nOC, nOB and nMM values
        xOC = max(0, xOC + xOC_change)
        xOB = max(0, xOB + xOB_change)
        xMM = max(0, xMM + xMM_change)
        nOC = xOC * N
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_3_second_line = pd.concat([df_figure_3_second_line, new_row], ignore_index=True)
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_3_third_line = pd.concat([df_figure_3_third_line, new_row], ignore_index=True)

        # Update the xOC, xOB, xMM values and the nOC, nOB and nMM values
        xOC = max(0, xOC + xOC_change)
        xOB = max(0, xOB + xOB_change)
        xMM = max(0, xMM + xMM_change)
        nOC = xOC * N
    ...
    df_figure_3_first_line.plot(ax=axes[0], x='Generation', y=['xOC', 'xOB', 'xMM', 'W_average'])
    ...
    df_figure_3_second_line.plot(ax=axes[1], x='Generation', y=['xOC', 'xOB', 'xMM', 'W_average'])
    axes[1].set_title('Dynamics for scenario where c2<c1<c3 (figure 3)')
    axes[1].set_xlabel('Generations')
    axes[1].set_ylabel('Fitness/Frequency')

    df_figure_3_third_line.plot(ax=axes[2], x='Generation', y=['xOC', 'xOB', 'xMM', 'W_average'])
...
def figure_8A():
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_8A_first_line = pd.concat([df_figure_8A_first_line, new_row], ignore_index=True)
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_8A_second_line = pd.concat([df_figure_8A_second_line, new_row], ignore_index=True)
...
def figure_8B():
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_8B_first_line = pd.concat([df_figure_8B_first_line, new_row], ignore_index=True)
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generation, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_8B_second_line = pd.concat([df_figure_8B_second_line, new_row], ignore_index=True)
...
def figure_9A():
    ...
    for generation in range(generations):
        ...
        # Update the xOC, xOB, xMM values and the nOC, nOB, nMM vales
        xOC = max(0, xOC + xOC_change)
        xOB = max(0, xOB + xOB_change)
        xMM = max(0, xMM + xMM_change)
        nOC = xOC * N
...
def figure_11():
    ...
    for generation in range(generations):
        ...
        new_row = pd.DataFrame([{'Generation':generations, 'xOC': xOC, 'xOB': xOB,
                                                'xMM': xMM, 'W_average': W_average}])
        df_figure_11_first_line = pd.concat([df_figure_11_first_line, new_row], ignore_index=True)

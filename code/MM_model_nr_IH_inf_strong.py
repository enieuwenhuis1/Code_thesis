...
def main():
    ...
    # by adaptive therapy
    list_t_steps_drug = [5, 5, 5]
    Figure_continuous_MTD_vs_AT_realistic(45, list_t_steps_drug)
...
def switch_dataframe(time_IH, n_switches, t_steps_drug, t_steps_no_drug, nOC, nOB, nMMd,
...
def Figure_continuous_MTD_vs_AT_realistic(n_switches, t_steps_drug):
    ...
    # Make dataframes for continiously administration
    df_total_GF = continuous_add_IH_df(30, 260, nOC, nOB, nMMd, nMMr,
                            growth_rates, growth_rates_IH, decay_rates,
                            decay_rates_IH, matrix_no_GF_IH, matrix_GF_IH)
    df_total_WMMd = continuous_add_IH_df(30, 260, nOC, nOB, nMMd, nMMr,
                    growth_rates, growth_rates_IH, decay_rates, decay_rates_IH,
                    matrix_no_GF_IH, matrix_no_GF_IH, WMMd_inhibitor)
    df_total_comb = continuous_add_IH_df(30, 260, nOC, nOB, nMMd, nMMr,
                    growth_rates, growth_rates_IH, decay_rates, decay_rates_IH,
                    matrix_no_GF_IH, matrix_GF_IH_comb, WMMd_inhibitor_comb)

    # Save the data
    save_dataframe(df_total_switch_GF, 'df_cell_nr_IH_inf_switch_GF_IH_s.csv',
                                            r'..\data\data_model_nr_IH_inf')
    save_dataframe(df_total_switch_WMMd, 'df_cell_nr_IH_inf_switch_WMMd_IH_s.csv',
                                            r'..\data\data_model_nr_IH_inf')
    save_dataframe(df_total_switch_comb, 'df_cell_nr_IH_inf_switch_comb_IH_s.csv',
                                            r'..\data\data_model_nr_IH_inf')
    save_dataframe(df_total_GF, 'df_cell_nr_IH_inf_continuous_GF_IH_s.csv',
                                             r'..\data\data_model_nr_IH_inf')
    save_dataframe(df_total_WMMd, 'df_cell_nr_IH_inf_continuous_WMMd_IH_s.csv',
                                             r'..\data\data_model_nr_IH_inf')
    save_dataframe(df_total_comb, 'df_cell_nr_IH_inf_continuous_comb_IH_s.csv',
                                             r'..\data\data_model_nr_IH_inf')
    ...
    fig.legend(labels = legend_labels, loc='upper center', ncol=4,
                                                                fontsize='large')
    save_Figure(plt, 'line_plot_cell_nr_IH_inf_AT_MTD_s',
                                 r'..\visualisation\results_model_nr_IH_inf')
    plt.show()

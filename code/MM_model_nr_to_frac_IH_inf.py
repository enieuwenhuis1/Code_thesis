...
def minimise_MM_GF_W_h():
    ...
    save_optimised_results(result,
            '..\data\data_model_nr_to_frac_IH_inf\optimise_GF_W_h.csv')
...
def minimise_MM_W_GF_h():
    ...
    # Save the results
    save_optimised_results(result,
            '..\data\data_model_nr_to_frac_IH_inf\optimise_W_GF_h.csv')
...
def minimise_MM_GF_h_W_h():
    ...
    # Save the results
    save_optimised_results(result,
            '..\data\data_model_nr_to_frac_IH_inf\optimise_GF_h_W_h.csv')
...
def minimise_MM_W_h_GF_h():
    ...
    # Save the results
    save_optimised_results(result,
            '..\data\data_model_nr_to_frac_IH_inf\optimise_W_h_GF_h.csv')
...
def minimise_MM_W_comb_GF_h_IH():
    ...
    result = minimize(minimal_tumour_nr_t_4_situations_IH, t_step_IH_strength,
        ...
        (0, None), (0, None), (0, 0.55), (0, None), (0, None), (0, None)],
        method='Nelder-Mead')

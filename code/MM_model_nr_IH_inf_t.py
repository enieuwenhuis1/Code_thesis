...
def main():
    ...
    Figure_continuous_MTD_vs_AT_increasing_MMr(90, list_t_steps_drug)
...
def Figure_continuous_MTD_vs_AT_increasing_MMr(n_switches, t_steps_drug):
    """ Function that makes a figure with 6 subplots showing the cell number
    ...
    fig.legend(labels = legend_labels, loc='upper center', ncol=5,
                                                            fontsize='x-large')
    # save_Figure(plt, 'line_plot_cell_nr_IH_inf_AT_MTD_h_MMr',
    #                              r'..\visualisation\results_model_nr_IH_inf')
    plt.show()

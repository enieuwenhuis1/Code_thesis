...
def main():
    ...
    # and MMr fraction
    Figure_continuous_MTD_vs_AT_discrete(0.3, 0.2)
...
def dynamics_discrete(time_IH, time_end, upper_limit_MMd, upper_limit_MMr, nOC,
                    nOB, nMMd, nMMr, growth_rates, decay_rates, matrix_no_drugs,
    ...
    df_fractions = number_to_fractions(df_numbers)
    ...
    for time_step in range(time_step_t):
        ...
        # Determine the MMr and MMd fraction
        ...
        new_row_df_frac = number_to_fractions(new_row_df)

...
def main():
    ...
    # by adaptive therapy
    list_t_steps_drug = [5, 5, 5]
    Figure_continuous_MTD_vs_AT_realistic(15, list_t_steps_drug)
...
def model_dynamics_IH(y, t, growth_rates, decay_rates, matrix, WMMd_inhibitor = 0):
    """Function that determines the number dynamics in a population over time.
...
def model_dynamics_no_I(y, t, growth_rates, decay_rates, matrix, WMMd_inhibitor = 0):
    """Function that determines the number dynamics in a population over time.
...
def Figure_continuous_MTD_vs_AT_realistic(n_switches, t_steps_drug):
    ...
    # Make dataframe for the different drug hollyday duration values
    df_total_switch_GF = switch_dataframe(30, n_switches, 60,
            4, nOC, nOB, nMMd, nMMr, growth_rates, growth_rates_IH,
            decay_rates, decay_rates_IH, matrix_no_GF_IH, matrix_GF_IH)
